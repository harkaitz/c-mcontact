...
__attribute__((weak)) extern const char *MCONTACT_DATABASE;
...
/* DATABASE */
bool mcontact_db_open     (mdb *, const char *_opt_mode);
...
bool mdb_iter_destroy        (mdb_iter **);

/* FTEMPLATE */
bool mcontact_ftemplate (FILE *_fp1, const mcontact *_c, const char _k[]);
